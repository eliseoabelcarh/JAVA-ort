...
public class Agencia {
	...
	public Agencia() {
		...
		marcas[0]= new Marca(1, "Ford");
		marcas[1]= new Marca(2, "Peugeot");
		marcas[2]= new Marca(3, "Toyota");
		marcas[3]= new Marca(4, "Fiat");
		
		this.autos.add(new Auto(1, "C50", 15000));
		this.autos.add(new Auto(1, "D50", 25000));
		this.autos.add(new Auto(2, "E50", 95000));
		this.autos.add(new Auto(2, "F50",55000));
		this.autos.add(new Auto(3, "G50", 65000));
		this.autos.add(new Auto(4, "H50", 27000));
		this.autos.add(new Auto(4, "I50", 85000));
		this.autos.add(new Auto(4, "J50", 35000));
	...
	public double getPrecioAuto(String modeloAuto) {
	 ...
	 public void informarValorPedido(int nroPedido) {
		 ...
		 if(precioPedido != -1) {
			 System.out.println("precio de pedido es " + precioPedido);
